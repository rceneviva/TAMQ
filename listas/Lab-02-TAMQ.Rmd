    ...
    ---
    title: "Lista de Exercícios 03 – Resolução Comentada"
    author: "Seu Nome"
    date: "`r Sys.Date()`"
    output: html_document
    ---

    > **Observação:** Este arquivo contém **todo o script R original** (abaixo) e pode ser gerado como HTML via **Knit** no RStudio.

    ```{r full-script, echo=TRUE, eval=FALSE}
